  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Auto-Sync Settings</h1>
        ...
        {loading ? (
          ...
          <div className="text-center py-12 bg-white rounded-lg shadow">
            ...
            <p className="mt-4 text-gray-600">No Gmail connections found</p>
        ...
        <div className="mt-8 bg-gray-100 rounded-lg p-4">
          <h3 className="font-semibold text-gray-900 mb-2">Cron Schedule</h3>
        ...
        <div className="mt-8 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          ...
          <div className="text-sm text-yellow-800 space-y-1">
            ...
            <p className="mt-2">
              Make sure <code className="bg-white px-1 rounded">CRON_SECRET</code>{' '}
