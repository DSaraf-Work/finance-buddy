    ...
    <ProtectedRoute>
      ...
      >
        <div className="py-6">
          ...
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-text-primary">Rejected Emails Management</h1>
            <p className="mt-2 text-text-secondary">Review and manage rejected emails</p>
          </div>
                          ...
                          <div className="flex items-center space-x-2">
                              ...
                              <button
                                ...
                                className={`px-3 py-1 rounded text-xs font-medium ${
                                  processingIds.has(rejectedEmail.id)
                                    ...
                                    : 'bg-error/10 text-error hover:bg-red-200'
                                }`}
                              >
                                Mark Invalid
                              </button>
                            ...
                            <button
                              ...
                              className={`px-3 py-1 rounded text-xs font-medium ${
                                processingIds.has(rejectedEmail.id)
                                  ? 'bg-gray-300 text-gray-500 cursor-not-allowed'
                                  : 'bg-bg-elevated/30 text-gray-800 hover:bg-gray-200'
                              }`}
                            >
                              Delete
                            </button>
