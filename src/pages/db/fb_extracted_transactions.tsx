      ...
      >
        <div className="py-6">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            {/* Header */}
            <div className="mb-6">
              <h1 className="text-2xl font-bold text-gray-900">Transaction Workbench</h1>
                    ...
                    <div>
                      ...
                      <dl className="grid grid-cols-1 gap-x-4 gap-y-3 sm:grid-cols-2">
                        ...
                        <div>
                          ...
                          <dd className="text-sm text-gray-900">{selectedTransaction.currency || 'N/A'}</dd>
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <dd className="text-sm text-gray-900">{selectedTransaction.category || 'N/A'}</dd>
                        </div>
                        <div>
                    ...
                    <div>
                      ...
                      <dl className="grid grid-cols-1 gap-x-4 gap-y-3">
                        ...
                        <div>
                          ...
                          <dd className="text-sm text-gray-900 font-mono">{selectedTransaction.connection_id || 'N/A'}</dd>
                        </div>
                        <div>
