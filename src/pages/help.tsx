...
const HelpPage: NextPage = () => {
  ...
  const renderGettingStarted = () => (
    <div className="space-y-8">
      <div>
        <h2 className="text-2xl font-bold text-text-primary mb-4">Welcome to Finance Buddy</h2>
      ...
      <div className="space-y-6">
        <div className="flex items-start">
          ...
          <div className="ml-4">
            <h3 className="text-lg font-medium text-text-primary">Create Your Account</h3>
        ...
        <div className="flex items-start">
          ...
          <div className="ml-4">
            <h3 className="text-lg font-medium text-text-primary">Connect Your Gmail Account</h3>
            <p className="text-text-secondary">
        ...
        <div className="flex items-start">
          ...
          <div className="ml-4">
            <h3 className="text-lg font-medium text-text-primary">Sync Your Emails</h3>
            <p className="text-text-secondary">
        ...
        <div className="flex items-start">
          ...
          <div className="ml-4">
            <h3 className="text-lg font-medium text-text-primary">Review and Manage</h3>
            <p className="text-text-secondary">
  ...
  const renderGmailSetup = () => (
    <div className="space-y-8">
      <div>
        <h2 className="text-2xl font-bold text-text-primary mb-4">Gmail Setup Guide</h2>
        <p className="text-text-secondary mb-6">
      ...
      <div className="space-y-6">
        <div>
          <h3 className="text-lg font-medium text-text-primary mb-3">Required Permissions</h3>
        ...
        <div>
          <h3 className="text-lg font-medium text-text-primary mb-3">Connection Process</h3>
        ...
        <div>
          <h3 className="text-lg font-medium text-text-primary mb-3">Managing Multiple Accounts</h3>
          <p className="text-text-secondary">
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        <div className="bg-red-50 border border-red-200 rounded-lg p-6">
          ...
          <ul className="list-disc list-inside space-y-1 text-error">
        ...
        <div className="bg-bg-primary/50 border border-border rounded-lg p-6">
          <h3 className="text-lg font-medium text-text-primary mb-2">🔍 No Emails Found</h3>
  ...
  const renderAPIDocumentation = () => (
    <div className="space-y-8">
      <div>
        <h2 className="text-2xl font-bold text-text-primary mb-4">API Documentation</h2>
        <p className="text-text-secondary mb-6">
      ...
      <div className="bg-bg-primary/50 border border-border rounded-lg p-6">
        <h3 className="text-lg font-medium text-text-primary mb-3">Authentication</h3>
        <p className="text-text-secondary mb-3">
      ...
      <div className="space-y-6">
        <div>
          <h3 className="text-lg font-medium text-text-primary mb-3">Gmail Endpoints</h3>
          <div className="space-y-4">
            <div className="border border-border rounded-lg p-4">
              <div className="flex items-center mb-2">
                <span className="bg-accent-emerald/10 text-accent-emerald px-2 py-1 rounded text-sm font-medium mr-3">GET</span>
                <code className="text-sm">/api/gmail/connections</code>
              </div>
              <p className="text-text-secondary text-sm">List all connected Gmail accounts</p>
            </div>
            ...
            <div className="border border-border rounded-lg p-4">
              ...
              <p className="text-text-secondary text-sm">Trigger manual email sync for a specific date range</p>
            </div>

            <div className="border border-border rounded-lg p-4">
              <div className="flex items-center mb-2">
                <span className="bg-error/10 text-error px-2 py-1 rounded text-sm font-medium mr-3">POST</span>
                <code className="text-sm">/api/gmail/disconnect</code>
              </div>
              <p className="text-text-secondary text-sm">Disconnect a Gmail account</p>
            </div>
          </div>
        </div>

        <div>
          <h3 className="text-lg font-medium text-text-primary mb-3">Search Endpoints</h3>
          <div className="space-y-4">
            <div className="border border-border rounded-lg p-4">
              <div className="flex items-center mb-2">
                <span className="bg-blue-100 text-blue-800 px-2 py-1 rounded text-sm font-medium mr-3">POST</span>
              ...
              <p className="text-text-secondary text-sm">Search and filter emails with pagination</p>
            </div>
            ...
            <div className="border border-border rounded-lg p-4">
              ...
              <p className="text-text-secondary text-sm">Search and filter extracted transactions</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            {/* Main Content */}
            <div className="flex-1 bg-bg-secondary shadow rounded-lg p-8">
              {renderContent()}
            </div>
          </div>
        </div>
