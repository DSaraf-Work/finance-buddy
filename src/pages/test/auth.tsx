...
const TestAuthPage: NextPage = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-airbnb-gray-light/50 py-12 px-4">
        <div className="max-w-4xl mx-auto">
          {/* Header */}
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-airbnb-text-primary mb-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-airbnb-white rounded-airbnb-md shadow p-6">
              <h2 className="text-xl font-semibold text-airbnb-text-primary mb-4">Sign In / Sign Up</h2>
            ...
            {/* Forgot Password */}
            <div className="bg-airbnb-white rounded-airbnb-md shadow p-6">
              <h2 className="text-xl font-semibold text-airbnb-text-primary mb-4">Forgot Password</h2>
              <p className="text-airbnb-text-secondary mb-4">
            ...
            {/* Reset Password */}
            <div className="bg-airbnb-white rounded-airbnb-md shadow p-6">
              <h2 className="text-xl font-semibold text-airbnb-text-primary mb-4">Reset Password</h2>
              <p className="text-airbnb-text-secondary mb-4">
            ...
            {/* Protected Routes */}
            <div className="bg-airbnb-white rounded-airbnb-md shadow p-6">
              <h2 className="text-xl font-semibold text-airbnb-text-primary mb-4">Protected Routes</h2>
              <p className="text-airbnb-text-secondary mb-4">
            ...
            {/* Authentication Flow */}
            <div className="bg-airbnb-white rounded-airbnb-md shadow p-6">
              <h2 className="text-xl font-semibold text-airbnb-text-primary mb-4">Authentication Flow</h2>
              <div className="text-sm text-airbnb-text-secondary space-y-2">
            ...
            {/* Password Reset Flow */}
            <div className="bg-airbnb-white rounded-airbnb-md shadow p-6">
              <h2 className="text-xl font-semibold text-airbnb-text-primary mb-4">Password Reset Flow</h2>
              <div className="text-sm text-airbnb-text-secondary space-y-2">
                <div className="flex items-center">
          ...
          {/* Quick Test Form */}
          <div className="mt-8 bg-airbnb-white rounded-airbnb-md shadow p-6">
            <h2 className="text-xl font-semibold text-airbnb-text-primary mb-4">Quick Test Form</h2>
            <p className="text-airbnb-text-secondary mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label className="block text-sm font-medium text-airbnb-text-secondary mb-1">Email</label>
                <input
                  type="email"
                  value={email}
              ...
              <div>
                <label className="block text-sm font-medium text-airbnb-text-secondary mb-1">Password</label>
                <input
                  type="password"
                  value={password}
              ...
              <div>
                <label className="block text-sm font-medium text-airbnb-text-secondary mb-1">Confirm Password</label>
                <input
                  type="password"
