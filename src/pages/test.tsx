...
import { ManualSyncRequest, ConnectionsResponse, ManualSyncResponse } from '@/types';
...
const TestPage: NextPage = () => {
  ...
  return (
    <ProtectedRoute>
      ...
      <div className="min-h-screen bg-airbnb-gray-light/50 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-airbnb-text-primary">Finance Buddy Testing Dashboard</h1>
            <p className="mt-2 text-airbnb-text-secondary">Comprehensive testing interface for L1 features validation</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            <div className="bg-airbnb-white rounded-airbnb-md shadow p-6">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-xl font-semibold text-airbnb-text-primary">System Health</h2>
                <button
                  onClick={fetchHealth}
                  className="px-3 py-1 bg-airbnb-red text-white rounded text-sm hover:bg-opacity-90"
                >
                  Refresh
                </button>
              </div>
              ...
              {health ? (
                <div className="space-y-3">
                  ...
                  <div>
                    <h3 className="font-medium text-airbnb-text-primary mb-2">Environment Variables</h3>
                  ...
                  <div>
                    <h3 className="font-medium text-airbnb-text-primary mb-2">Database</h3>
            ...
            <div className="bg-airbnb-white rounded-airbnb-md shadow p-6">
              <h2 className="text-xl font-semibold text-airbnb-text-primary mb-4">API Testing</h2>
              
              <div className="space-y-4">
                <button
                  onClick={testAllEndpoints}
                  disabled={loading}
                  className="w-full px-4 py-2 bg-airbnb-red text-white rounded hover:bg-opacity-90 disabled:opacity-50"
                >
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <button
                    onClick={() => testEndpoint('/api/gmail/connections')}
                    className="px-3 py-2 bg-airbnb-red text-white rounded text-sm hover:bg-opacity-90"
                  >
                    Test Connections
                  </button>
                  <button
          ...
          {/* Manual Sync Testing */}
          <div className="bg-airbnb-white rounded-airbnb-md shadow p-6 mb-8">
            <h2 className="text-xl font-semibold text-airbnb-text-primary mb-4">Manual Sync Testing</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
              <div>
                <label className="block text-sm font-medium text-airbnb-text-secondary mb-1">Connection ID</label>
                <input
                  type="text"
                  value={syncForm.connection_id}
                  onChange={(e) => setSyncForm(prev => ({ ...prev, connection_id: e.target.value }))}
                  className="w-full px-3 py-2 border border-airbnb-border-light rounded-airbnb-md text-sm"
                  placeholder="test-connection-id"
                />
              </div>
              
              <div>
                <label className="block text-sm font-medium text-airbnb-text-secondary mb-1">Date From</label>
                <input
                  type="date"
              ...
              <div>
                <label className="block text-sm font-medium text-airbnb-text-secondary mb-1">Date To</label>
                <input
                  type="date"
          ...
          <div className="bg-airbnb-white rounded-airbnb-md shadow p-6 mb-8">
            <h2 className="text-xl font-semibold text-airbnb-text-primary mb-4">Additional Testing Tools</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <a
                href="/test/auth"
                className="block p-4 border border-airbnb-border-light rounded-airbnb-md hover:border-blue-300 hover:bg-blue-50 transition-colors"
              >
                <div className="flex items-center">
                  <div className="text-2xl mr-3">🔐</div>
                  <div>
                    <h3 className="font-medium text-airbnb-text-primary">Authentication Testing</h3>
                    <p className="text-sm text-airbnb-text-secondary">Test auth flows, password reset, and route protection</p>
                  </div>
                </div>
              </a>

              <div className="p-4 border border-airbnb-border-light rounded-airbnb-md bg-gray-50">
                <div className="flex items-center">
                  <div className="text-2xl mr-3">🚧</div>
                  <div>
          ...
          {/* Test Results */}
          <div className="bg-airbnb-white rounded-airbnb-md shadow">
            <div className="px-6 py-4 border-b border-airbnb-border-light">
              <h2 className="text-xl font-semibold text-airbnb-text-primary">Recent Test Results</h2>
            </div>
              ...
              {testResults.length === 0 ? (
                ...
                testResults.map((result, index) => (
                  <div key={index} className="px-6 py-4">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center">
                        ...
                        <span className={`ml-2 px-2 py-1 text-xs rounded ${
                          result.status === 200 ? 'bg-green-50 text-green-700' :
                    ...
                    <div className="bg-airbnb-gray-light/50 rounded p-3 text-sm">
