...
const TestPage: NextPage = () => {
  ...
  return (
    <ProtectedRoute>
      ...
      <div className="min-h-screen bg-bg-primary/50 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-text-primary">Finance Buddy Testing Dashboard</h1>
            <p className="mt-2 text-text-secondary">Comprehensive testing interface for L1 features validation</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            <div className="bg-bg-secondary rounded-lg shadow p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  onClick={fetchHealth}
                  className="px-3 py-1 bg-brand-primary text-white rounded text-sm hover:bg-brand-hover"
                >
                  Refresh
                </button>
              </div>
              ...
              {health ? (
                <div className="space-y-3">
                  ...
                  <div>
                    <h3 className="font-medium text-text-primary mb-2">Environment Variables</h3>
                  ...
                  <div>
                    <h3 className="font-medium text-text-primary mb-2">Database</h3>
            ...
            <div className="bg-bg-secondary rounded-lg shadow p-6">
              <h2 className="text-xl font-semibold text-text-primary mb-4">API Testing</h2>
              
              <div className="space-y-4">
                <button
                  onClick={testAllEndpoints}
                  disabled={loading}
                  className="w-full px-4 py-2 bg-brand-primary text-white rounded hover:bg-brand-hover disabled:opacity-50"
                >
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <button
                    onClick={() => testEndpoint('/api/gmail/connections')}
                    className="px-3 py-2 bg-brand-primary text-white rounded text-sm hover:bg-brand-hover"
                  >
                    Test Connections
                  </button>
                  <button
          ...
          {/* Manual Sync Testing */}
          <div className="bg-bg-secondary rounded-lg shadow p-6 mb-8">
            <h2 className="text-xl font-semibold text-text-primary mb-4">Manual Sync Testing</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
              <div>
                <label className="block text-sm font-medium text-text-secondary mb-1">Connection ID</label>
                <input
                  type="text"
          ...
          <div className="bg-bg-secondary rounded-lg shadow p-6 mb-8">
            <h2 className="text-xl font-semibold text-text-primary mb-4">Additional Testing Tools</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <a
                href="/test/auth"
                className="block p-4 border border-border rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-colors"
              >
                <div className="flex items-center">
                  <div className="text-2xl mr-3">🔐</div>
                  <div>
                    <h3 className="font-medium text-text-primary">Authentication Testing</h3>
                    <p className="text-sm text-text-secondary">Test auth flows, password reset, and route protection</p>
                  </div>
                </div>
              </a>
              ...
              {testResults.length === 0 ? (
                ...
                testResults.map((result, index) => (
                  <div key={index} className="px-6 py-4">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center">
                        ...
                        <span className={`ml-2 px-2 py-1 text-xs rounded ${
                          result.status === 200 ? 'bg-accent-emerald/10 text-accent-emerald' :
                    ...
                    <div className="bg-bg-primary/50 rounded p-3 text-sm">
