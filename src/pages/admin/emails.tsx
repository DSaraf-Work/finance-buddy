  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Admin - Email Management</h1>
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Whitelisted Senders</h2>
          ...
          <div className="space-y-2">
            {whitelistedSenders.length === 0 ? (
              ...
              whitelistedSenders.map((sender) => (
                ...
                >
                  <span className="text-gray-900 font-mono text-sm">{sender}</span>
                  <button
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              <h3 className="font-semibold text-gray-900 mb-2">Refresh Emails from Gmail</h3>
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              <h3 className="font-semibold text-gray-900 mb-2">Process All Fetched Emails</h3>
              <p className="text-sm text-gray-600 mb-3">
