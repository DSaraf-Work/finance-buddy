...
export class AuditLogger {
  ...
  static async updateAuditLog(
    ...
    try {
      ...
      if (updates.emailIds !== undefined) updateData.email_ids = updates.emailIds;
      if (updates.transactionIds !== undefined) updateData.transaction_ids = updates.transactionIds;
