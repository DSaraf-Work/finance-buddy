...
export function PushNotificationPrompt() {
  ...
  if (permission === 'denied') {
    return (
      <div className="bg-yellow-50 border border-yellow-200 rounded-airbnb-md p-4">
  ...
  if (isSubscribed) {
    ...
    return (
      <div className="bg-green-50 border border-green-200 rounded-airbnb-md p-4">
        ...
        <button
          ...
          disabled={loading}
          className="w-full bg-green-600 text-white px-4 py-2 rounded-airbnb-md text-sm font-medium hover:bg-green-700 disabled:opacity-50 transition-colors"
        >
  ...
  return (
    <div className="bg-blue-50 border border-blue-200 rounded-airbnb-md p-4">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <button
            ...
            disabled={loading}
            className="bg-airbnb-red text-white px-4 py-2 rounded-airbnb-md text-sm font-medium hover:bg-opacity-90 disabled:opacity-50 transition-colors"
          >
