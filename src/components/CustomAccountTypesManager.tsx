  ...
  return (
    <div className={`bg-white shadow rounded-lg ${className}`}>
      <div className="px-6 py-4 border-b border-gray-200">
        <h2 className="text-lg font-medium text-gray-900">💳 Custom Account Types</h2>
      ...
      <div className="p-6">
        ...
        <div className="mb-6">
          <label htmlFor="new-account-type" className="block text-sm font-medium text-gray-700 mb-2">
            Add New Account Type
          </label>
              ...
              {customAccountTypes.map((accountType) => (
                ...
                >
                  <div className="flex items-center">
                    ...
                    <span className="text-sm font-medium text-gray-900">{accountType}</span>
                  </div>
                  <button
