...
const ReviewFilters: React.FC<ReviewFiltersProps> = ({
  ...
  return (
    <div className="bg-[#1a1625] rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.3)] border border-[#2d1b4e] p-4 sm:p-5 lg:p-6 mb-6 sm:mb-8">
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full pl-10 pr-3 sm:pr-4 py-2 sm:py-2.5 bg-[#0f0a1a] border border-[#2d1b4e] rounded-lg text-[#f8fafc] placeholder-[#94a3b8] focus:ring-2 focus:ring-[#6b4ce6] focus:border-[#6b4ce6] transition-all duration-200"
