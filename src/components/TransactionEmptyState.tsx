...
export default function TransactionEmptyState({ onRefresh }: TransactionEmptyStateProps) {
  return (
    <div className="relative bg-[var(--color-bg-primary)] rounded-[var(--radius-lg)] p-12 sm:p-16 shadow-[var(--shadow-sm)] border border-[var(--color-border)]">
      {/* Purple Top Border */}
      ...
      <div className="text-center max-w-lg mx-auto" role="status" aria-live="polite">
        {/* Illustration */}
        <div className="mb-8">
          <div className="inline-flex items-center justify-center w-28 h-28 bg-gradient-to-br from-[#5D5FEF] to-[#888BFF] rounded-3xl mb-6 shadow-[var(--shadow-lg)]">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
          <button
            onClick={onRefresh}
            className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-[#5D5FEF] to-[#888BFF] text-white rounded-[var(--radius-lg)] hover:shadow-[var(--shadow-xl)] hover:shadow-[#5D5FEF]/30 transition-all duration-300 font-semibold flex items-center justify-center"
          ...
          <a
            href="/emails"
            className="w-full sm:w-auto px-8 py-4 bg-[var(--color-bg-card)] text-[var(--color-text-secondary)] border-2 border-[var(--color-border)] rounded-[var(--radius-lg)] hover:border-[var(--color-accent-primary)] hover:text-[var(--color-accent-hover)] transition-all duration-300 font-semibold flex items-center justify-center"
        ...
        <div className="pt-8 border-t border-[var(--color-border)]">
          <p className="text-sm font-semibold text-[var(--color-text-secondary)] mb-4 flex items-center justify-center gap-2">
