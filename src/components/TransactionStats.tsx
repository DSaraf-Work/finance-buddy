...
const TransactionStats = memo(function TransactionStats({ total, totalAmount, avgConfidence, loading = false }: TransactionStatsProps) {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 lg:gap-6 mb-10 sm:mb-12">
      ...
      <div className="relative bg-[#15161A] rounded-2xl p-6 hover:shadow-xl transition-all duration-300 overflow-hidden border border-[#2A2C35] shadow-sm">
        ...
        <div className="relative z-10">
          <div className="flex items-start justify-between mb-4">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#5D5FEF] to-[#888BFF] flex items-center justify-center shadow-md">
      ...
      {/* Total Amount Card */}
      <div className="relative bg-[#15161A] rounded-2xl p-6 hover:shadow-xl transition-all duration-300 overflow-hidden border border-[#2A2C35] shadow-sm">
        {/* Success Green Top Border (flat, no gradient) */}
        <div className="absolute top-0 left-0 right-0 h-1 bg-[#4ECF9E]"></div>

        {/* Content */}
        <div className="relative z-10">
          <div className="flex items-start justify-between mb-4">
            <div className="w-12 h-12 rounded-xl bg-[#4ECF9E] flex items-center justify-center shadow-md">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
      ...
      {/* AI Confidence Card */}
      <div className="relative bg-[#15161A] rounded-2xl p-6 hover:shadow-xl transition-all duration-300 overflow-hidden border border-[#2A2C35] shadow-sm">
        {/* Info Blue Top Border (flat, no gradient) */}
        <div className="absolute top-0 left-0 right-0 h-1 bg-[#6C85FF]"></div>

        {/* Content */}
        <div className="relative z-10">
          <div className="flex items-start justify-between mb-4">
            <div className="w-12 h-12 rounded-xl bg-[#6C85FF] flex items-center justify-center shadow-md">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
