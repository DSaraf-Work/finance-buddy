...
const HelpPage: NextPage = () => {
  ...
  const renderGettingStarted = () => (
    <div className="space-y-8">
      <div>
        <h2 className="text-2xl font-bold text-gray-900 mb-4">Welcome to Finance Buddy</h2>
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-start">
          ...
          <div className="ml-4">
            <h3 className="text-lg font-medium text-gray-900">Sync Your Emails</h3>
            <p className="text-gray-600">
        ...
        <div className="flex items-start">
          ...
          <div className="ml-4">
            <h3 className="text-lg font-medium text-gray-900">Review and Manage</h3>
            <p className="text-gray-600">
  ...
  const renderGmailSetup = () => (
    <div className="space-y-8">
      <div>
        <h2 className="text-2xl font-bold text-gray-900 mb-4">Gmail Setup Guide</h2>
        <p className="text-gray-600 mb-6">
      ...
      <div className="space-y-6">
        <div>
          <h3 className="text-lg font-medium text-gray-900 mb-3">Required Permissions</h3>
        ...
        <div>
          <h3 className="text-lg font-medium text-gray-900 mb-3">Connection Process</h3>
        ...
        <div>
          <h3 className="text-lg font-medium text-gray-900 mb-3">Managing Multiple Accounts</h3>
          <p className="text-gray-600">
  ...
  const renderAPIDocumentation = () => (
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        <div>
          <h3 className="text-lg font-medium text-gray-900 mb-3">Gmail Endpoints</h3>
          <div className="space-y-4">
            <div className="border border-gray-200 rounded-lg p-4">
              ...
              <p className="text-gray-600 text-sm">List all connected Gmail accounts</p>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              ...
              <p className="text-gray-600 text-sm">Trigger manual email sync for a specific date range</p>
            </div>

            <div className="border border-gray-200 rounded-lg p-4">
              <div className="flex items-center mb-2">
                <span className="bg-red-100 text-red-800 px-2 py-1 rounded text-sm font-medium mr-3">POST</span>
                <code className="text-sm">/api/gmail/disconnect</code>
              </div>
              <p className="text-gray-600 text-sm">Disconnect a Gmail account</p>
            </div>
          </div>
        </div>

        <div>
          <h3 className="text-lg font-medium text-gray-900 mb-3">Search Endpoints</h3>
          <div className="space-y-4">
            <div className="border border-gray-200 rounded-lg p-4">
              <div className="flex items-center mb-2">
                <span className="bg-blue-100 text-blue-800 px-2 py-1 rounded text-sm font-medium mr-3">POST</span>
              ...
              <p className="text-gray-600 text-sm">Search and filter emails with pagination</p>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              ...
              <p className="text-gray-600 text-sm">Search and filter extracted transactions</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            {/* Main Content */}
            <div className="flex-1 bg-white shadow rounded-lg p-8">
              {renderContent()}
            </div>
          </div>
        </div>
