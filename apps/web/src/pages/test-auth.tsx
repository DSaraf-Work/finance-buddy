        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">Sign In / Sign Up</h2>
            ...
            {/* Password Reset Flow */}
            <div className="bg-white rounded-lg shadow p-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">Password Reset Flow</h2>
              <div className="text-sm text-gray-600 space-y-2">
                <div className="flex items-center">
          ...
          <div className="mt-8 bg-white rounded-lg shadow p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Quick Test Form</h2>
            <p className="text-gray-600 mb-4">
